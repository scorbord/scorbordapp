Before('@football-seed') do
  ...
  DataFixtures.football_offensive_coach_positions.each do |ocp_attrs|
    ocp_attrs.merge!({:position_type => 1, :sport => 1, :side => 1})
  ...
  DataFixtures.football_offensive_position_units.each do |opu_attrs|
    ...
    opu_attrs.merge!(parent_unit_id: offense_unit.id, coach_position_id: coach_pos_id, unit_type: 'PositionUnit')
  ...
  DataFixtures.football_offense_player_positions.each do |opp_attrs|
    ...
    opp_attrs.merge!(unit_id: unit_id, side: 1, position_type: 2, sport: 1)
  ...
  DataFixtures.football_defensive_coach_positions.each do |dcp_attrs|
    dcp_attrs.merge!({:position_type => 1, :sport => 1, :side => 2})
  ...
  DataFixtures.football_defensive_position_units.each do |dpu_attrs|
    ...
    dpu_attrs.merge!(parent_unit_id: defense_unit.id, coach_position_id: coach_pos_id, unit_type: 'PositionUnit')
  ...
  DataFixtures.football_defense_player_positions.each do |dpp_attrs|
    ...
    dpp_attrs.merge!(unit_id: unit_id, side: 2, position_type: 2, sport: 1)
  ...
  DataFixtures.football_specialteams_coach_positions.each do |stcp_attrs|
    stcp_attrs.merge!({:position_type => 1, :sport => 1, :side => 3})
  ...
  DataFixtures.football_specialteams_position_units.each do |stpu_attrs|
    ...
    stpu_attrs.merge!(parent_unit_id: st_unit.id, coach_position_id: coach_pos_id, unit_type: 'PositionUnit')
  ...
  DataFixtures.football_specialteams_player_positions.each do |stpp_attrs|
    ...
    stpp_attrs.merge!(unit_id: unit_id, side: 3, position_type: 2, sport: 1)
